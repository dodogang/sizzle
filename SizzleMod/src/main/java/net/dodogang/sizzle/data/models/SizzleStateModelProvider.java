...
import net.dodogang.sizzle.data.models.stategen.IBlockStateGen;
...
public class SizzleStateModelProvider implements IDataProvider {
    ...
    public SizzleStateModelProvider(DataGenerator datagen) {
