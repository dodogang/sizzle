package net.dodogang.sizzle.data.models.modelgen;
...
public class InheritingModelGen implements IModelGen {
    ...
    public static InheritingModelGen step(String texture) {
        return new InheritingModelGen("sizzle:block/step")
                   .texture("bottom", texture)
                   .texture("top", texture)
                   .texture("side", texture);
    }
    ...
    public static InheritingModelGen stepInner(String texture) {
        return new InheritingModelGen("sizzle:block/inner_step")
                   .texture("bottom", texture)
                   .texture("top", texture)
                   .texture("side", texture);
    }
    ...
    public static InheritingModelGen stepOuter(String texture) {
        return new InheritingModelGen("sizzle:block/outer_step")
                   .texture("bottom", texture)
                   .texture("top", texture)
                   .texture("side", texture);
    }
    ...
    public static InheritingModelGen grassBlock(String top, String side, String bottom, String overlay) {
        return new InheritingModelGen("sizzle:block/grass_block")
                   .texture("top", top)
                   .texture("bottom", bottom)
                   .texture("side", side)
    ...
    public static InheritingModelGen farmlandBlock(String top, String side, String bottom) {
        return new InheritingModelGen("sizzle:block/farmland_block")
                   .texture("top", top)
                   .texture("bottom", bottom)
                   .texture("side", side);
    }
