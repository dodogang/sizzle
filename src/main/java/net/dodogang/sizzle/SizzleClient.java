...
public class SizzleClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        BlockRenderLayerMap.INSTANCE.putBlocks(RenderLayer.getCutout(), SizzleBlocks.TALL_CRIMSON_ROOTS, SizzleBlocks.TALLER_CRIMSON_ROOTS, SizzleBlocks.TALL_WARPED_ROOTS, SizzleBlocks.TALLER_WARPED_ROOTS, SizzleBlocks.BROWN_CAP_BED, SizzleBlocks.RAND_CAP_BED, SizzleBlocks.RED_CAP_BED);
